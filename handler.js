...
text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await this.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '𝗦𝘂𝗽𝗲𝗿 𝙁𝙖𝙨𝙩-𝘽𝙤𝙩') :
...
"thumbnail": apii.data, 
"title": [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + ft + ' 😻', '🌟 https://instagram.com/gabiacosta06'].getRandom(),
...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: lenguajeGB.smsAvisoAG().slice(0,-2), body: [wm, '😻 𝗦𝘂𝗽𝗲𝗿 ' + ft + ' 😻', '🌟 https://instagram.com/gabiacosta06'].getRandom(), thumbnail: fastImg.getRandom(), sourceUrl: [md, nna,yt, ig, paypal, fb].getRandom() }}}}, tg)
